        ...
        <div className='mt-16'>
            <div className="flex flex-col justify-center items-center">
                <div className='md:text-3xl text-xl flex gap-2'>
                    <h1 className={`${fontRobonto.className} font-bold hover:scale-[1.02]`}>Education</h1> 🎓
                </div>
...
const educationContent = [
    {
        ...
        image: null,
        imageAlt: "MAS-YIA Panembong"
    },
    {
        title: "SMP ISLAM Rajapolah",
        time: "2018 - 2021",
        badge: "Middle School",
        status: "",
        description: [
